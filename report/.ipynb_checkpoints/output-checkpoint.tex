...
\authornameonly{Bernard Lo (z3464235) Andrew Ryan (z2251397) Chadi Abi
Fadel (z5442788) Joshua Evans (z5409600) }
...
\usepackage{array} % Make sure to include this package
\usepackage{longtable} % For long tables that span multiple pages
\usepackage{booktabs} % For professional-looking horizontal rules
...
\par
% Ensure there's enough space for the big skip to work properly
\vspace{\baselineskip}
\bigskip
...
\begin{longtable}{@{} >{\raggedright\arraybackslash}p{0.62\textwidth} >{\raggedright\arraybackslash}p{0.126\textwidth} >{\raggedleft\arraybackslash}p{0.084\textwidth} >{\raggedleft\arraybackslash}p{0.084\textwidth} >{\raggedleft\arraybackslash}p{0.084\textwidth} @{}}
\toprule
